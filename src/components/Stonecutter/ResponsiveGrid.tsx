...
const ResponsiveGrid: React.FC<ResponsiveGridInterface> = 
    ({options: {maxWidth, minPadding, defaultColumns, widthCoef, defaultcolumnWidth, defaultGutterWidth}, children}) => {
        
        const Grid = measureItems(SpringGrid);

        const [gutterWidth, setGutterWidth] = useState(defaultGutterWidth);
